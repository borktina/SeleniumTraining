...
public class Read_DataFrom_Json {
	@Test
	public static void Flight_Login() throws IOException, ParseException, org.json.simple.parser.ParseException {
		...
		JSONObject jsonobj = (JSONObject) jsonparser.parse(new FileReader(System.getProperty("user.dir")+"\\src\\test\\java\\Com_resourceFile\\ObjectRepository.json"));
